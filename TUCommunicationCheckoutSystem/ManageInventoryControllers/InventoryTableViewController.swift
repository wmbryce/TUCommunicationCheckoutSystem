    ...
    @IBAction func AddKit(_ sender: Any) {
        ...
        let saveAction = UIAlertAction(title: "Save", style: .default) { _ in
            ...
            if self.checkForValidKitNumber(testKit:newkitNumber){
                ...
                let newKit = Kit(kitNumber: newkitNumber, items: Items , checkIn: Checkin_out_Date as String, checkOut: Checkin_out_Date as String, lastUsers: ["None"], available: true)
