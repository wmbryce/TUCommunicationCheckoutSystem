...
#import "UgiBarcodeConfiguration.h"
...
//! @cond
//! YES if the reader has a HF reader
@property (readonly, nonatomic) BOOL hasHfReader;

//! HF firmware version, major
@property (readonly, nonatomic) int hfFirmwareVersionMajor;
//! HF firmware version, minor
@property (readonly, nonatomic) int hfFirmwareVersionMinor;
//! HF firmware version, build
@property (readonly, nonatomic) int hfFirmwareVersionBuild;

//! YES if the reader has a barcode reader
@property (readonly, nonatomic) BOOL hasBarcodeReader;

//! Barcode firmware version, major
@property (readonly, nonatomic) int barcodeFirmwareVersionMajor;
//! Barcode firmware version, minor
@property (readonly, nonatomic) int barcodeFirmwareVersionMinor;
//! Barcode firmware version, build
@property (readonly, nonatomic) int barcodeFirmwareVersionBuild;
...
typedef enum {
  ...
  UGI_ONGOING_OPERATION_BARCODE_SCAN     //!< Barcode scan in progress
...
typedef void (^XamarinReportConnectionStateAndBatteryInfoCallback)(NSArray *_Nonnull ia,
                                                                   NSString * _Nonnull statusDescription);
- (nonnull id) xamarinReportConnectionStateAndBatteryInfoPeriodically:(nonnull XamarinReportConnectionStateAndBatteryInfoCallback)callback;
//! @endcond
...
/**
 ...
 @param configuration  Barcode configuration to use
 @param completion     Code to run when barcode scan is completed
 @return            YES if scan started, NO if Grokker not connected,
                    or Grokker dos not have a barcode reader
 */
 ...
 */
extern void UgiLog(NSString * _Nonnull format, ...) NS_FORMAT_FUNCTION(1,2) NS_NO_TAIL_CALL;
...
/**
 ...
 <br>
 Version 1.16.5 - January 11, 2018 - Reader protocol 27<br>
   Fix to work with very old firmware (1.6.2) still in a few Grokkers<br>
   Minor bug fixes<br>
 <br>
 Version 1.16.6 - March 9, 2018 - Reader protocol 27<br>
   Fix bug writing more than 200 bytes to memory when previous memory contents are unknown<br>
 <br>
 Version 1.16.7 - May 4, 2018 - Reader protocol 27<br>
   Change "Grokker" references to "PD20"<br>
 <br>
 Version 1.16.8 - May 29, 2018 - Reader protocol 28<br>
   Fix bug with SINGLE_FIND mode when passing EPCs to ignore<br>
 <br>
 Version 1.16.9 - June 6, 2018 - Reader protocol 28<br>
   Add parameter checking to catch illegal combinations in UgiRfidConfiguration<br>
 <br>
 Version 1.16.12 - July 23, 2018 - Reader protocol 28<br>
   Updated French translations<br>
 <br>
 Version 1.16.13 - October 25, 2018 - Reader protocol 28<br>
   Fixed memory leaks<br>
   UI tweaks and cleanups<br>
 */
