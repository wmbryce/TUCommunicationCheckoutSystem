...
///////////////////////////////////////////////////////////////////////////////////////
#pragma mark - UgiThemeColored
///////////////////////////////////////////////////////////////////////////////////////

//! @cond
@protocol UgiThemeColored
...
#define UGI_ALERT_LEFT_JUSTIFY @"@left@"
#define UGI_ALERT_SMALLER_TEXT @"@smaller@"
...
/**
 ...
 @param width    New width (or -1 to remove width constraint)
 @return          Previous width constraint constant
 */
- (float) setWidthConstraint:(float)width;

/**
 Set or modify the height constraint for a view
 @param height    New height (or -1 to remove height constraint)
 @return          Previous height constraint constant
 */
- (float) setHeightConstraint:(float)height;

/**
 Constrain a view to its parent
 @param left    Constraint for left, or -1 for none
 @param top     Constraint for left, or -1 for none
 @param right   Constraint for left, or -1 for none
 @param bottom  Constraint for left, or -1 for none
 */
...
/**
 ...
 @param size    Size to constrain to
 @return        Text size
 */
